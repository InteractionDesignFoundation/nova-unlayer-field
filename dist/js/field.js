...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  beforeCreate: function beforeCreate() {
    this.iframeId = "".concat(this.field.uniqueKey, "-iframe");
  },
  ...
  methods: {
     ...
     */
    setIframeContent: function setIframeContent(iframe, htmlContent) {
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _UnlayerEditor_vue__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./UnlayerEditor.vue */ "./resources/js/components/UnlayerEditor.vue");
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  components: {
    UnlayerEditor: _UnlayerEditor_vue__WEBPACK_IMPORTED_MODULE_0__["default"]
  },
  ...
  methods: {
    /** Register listeners, load initial template, etc. */editorLoaded: function editorLoaded() {
    ...
    fill: function fill(formData) {
      ...
      formData.append("".concat(this.currentField.attribute, "_html"), this.html);
    },
    /**
     * @param {{design: Object}} loadedDesign
     */
    handleDesignLoaded: function handleDesignLoaded(loadedDesign) {
      var _this = this;
      this.$refs.editor.exportHtml(function (editorData) {
        _this.design = editorData.design;
        _this.html = editorData.html;
      });
     ...
     * @returns {Object}
     */
    getDesignWithUpdatedNode: function getDesignWithUpdatedNode(updatedNode, design) {
      var htmlIdOfChangedNode = updatedNode.values._meta.htmlID;
      design.body.rows.find(function (row, rowIndex) {
        return row.columns.find(function (column, columnIndex) {
          return column.contents.find(function (currentNode, contentIndex) {
     ...
     */
    handleDesignUpdated: function handleDesignUpdated(changeLog) {
      var _this2 = this;
      var originalChangedItemAsString = JSON.stringify(changeLog.item);

      /** @type {Object} */
      var updatedByPluginsNode = Object.values(window.unlayer.plugins).reduce(function (prev, pluginFn) {
        return pluginFn(prev, changeLog.type, changeLog.changes);
      }, changeLog.item);
      var updatedChangeLogAsString = JSON.stringify(updatedByPluginsNode);
      if (originalChangedItemAsString === updatedChangeLogAsString) {
        this.$refs.editor.exportHtml(function (editorData) {
          _this2.design = editorData.design;
          _this2.html = editorData.html;
        });
      } else {
        /**
         ...
         */
        this.$refs.editor.exportHtml(function (editorData) {
          var design = _this2.getDesignWithUpdatedNode(updatedByPluginsNode, editorData.design);
          _this2.$refs.editor.loadDesign(design);
          _this2.$refs.editor.exportHtml(function (editorData) {
            _this2.design = editorData.design;
            _this2.html = editorData.html;
          });
        });
     ...
     */
    handleImageUploaded: function handleImageUploaded(imageData) {
    ...
    toggleFullscreen: function toggleFullscreen() {
      ...
      var unlayerEditorContainer = this.$el.querySelector(".fullscreenable");
      unlayerEditorContainer.classList.toggle('z-50'); // increase z-index
      unlayerEditorContainer.classList.toggle('fullscreen');
      var controls = this.$el.querySelector('.unlayerControls');
      controls.classList.toggle('stickyControls');
      var trans = function trans(key) {
        return Nova.config('translations')[key];
      };
      var toggleButton = controls.querySelector("#fullscreenToggleButton");
      unlayerEditorContainer.classList.contains('fullscreen') ? toggleButton.innerText = trans('Exit fullscreen') : toggleButton.innerText = trans('Enter fullscreen');
    }
  }
});
...
/***/ "./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/dist/index.js??ruleSet[0].use[0]!./resources/js/components/UnlayerEditor.vue?vue&type=script&lang=js":
/*!*******************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/dist/index.js??ruleSet[0].use[0]!./resources/js/components/UnlayerEditor.vue?vue&type=script&lang=js ***!
  \*******************************************************************************************************************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  created: function created() {
    var _this = this;
    var unlayerScript = document.createElement('script');
    unlayerScript.setAttribute('src', '//editor.unlayer.com/embed.js');
    unlayerScript.onload = function () {
      _this.loadEditor();
    };
  ...
  methods: {
    ...
    loadTemplate: function loadTemplate(templateId) {
...
var _hoisted_2 = {
  "class": "unlayerControls flex"
};
function render(_ctx, _cache, $props, $setup, $data, $options) {
  var _component_UnlayerEditor = (0,vue__WEBPACK_IMPORTED_MODULE_0__.resolveComponent)("UnlayerEditor");
  ...
  return (0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createBlock)(_component_DefaultField, {
    ...
    field: (0,vue__WEBPACK_IMPORTED_MODULE_0__.withCtx)(function () {
      return [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_1, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_2, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("button", {
        ...
        type: "button"
      }, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(_ctx.__('Enter fullscreen')), 1 /* TEXT */)]), ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createBlock)(_component_UnlayerEditor, {
        "class": "form-input-bordered",
        style: (0,vue__WEBPACK_IMPORTED_MODULE_0__.normalizeStyle)({
          minHeight: $options.containerHeight
        }),
        ref: "editor",
        onLoad: $options.editorLoaded,
        locale: _ctx.currentField.config.locale,
        projectId: _ctx.currentField.config.projectId,
        templateId: _ctx.currentField.value ? null : _ctx.currentField.config.templateId,
        options: $options.unProxy(_ctx.currentField.config),
        key: _ctx.currentField.config.key
      }, null, 8 /* PROPS */, ["style", "onLoad", "locale", "projectId", "templateId", "options"]))])];
    }),
    _: 1 /* STABLE */
...
function render(_ctx, _cache, $props, $setup, $data, $options) {
  return (0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("code", null, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)($props.field.value), 1 /* TEXT */);
}

/***/ }),

/***/ "./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/dist/templateLoader.js??ruleSet[1].rules[2]!./node_modules/vue-loader/dist/index.js??ruleSet[0].use[0]!./resources/js/components/UnlayerEditor.vue?vue&type=template&id=657d8b0a":
/*!***********************************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/dist/templateLoader.js??ruleSet[1].rules[2]!./node_modules/vue-loader/dist/index.js??ruleSet[0].use[0]!./resources/js/components/UnlayerEditor.vue?vue&type=template&id=657d8b0a ***!
  \***********************************************************************************************************************************************************************************************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
function render(_ctx, _cache, $props, $setup, $data, $options) {
  return (0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("div", {
    id: $props.id,
    "class": "flex h-full unlayerIframeContainer"
...
// Module
___CSS_LOADER_EXPORT___.push([module.id, "\n.fullscreen[data-v-c023248a] {\n        position: fixed;\n        left: 1vw;\n        top: 1vh;\n        width: 98vw !important;\n        height: 98vh !important;\n}\n.stickyControls[data-v-c023248a] {\n        position: fixed;\n        left: 1vw;\n        top: 1vh;\n        z-index: 51;\n}\n", ""]);
// Exports
...
/***/ "./node_modules/css-loader/dist/cjs.js??clonedRuleSet-8.use[1]!./node_modules/vue-loader/dist/stylePostLoader.js!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-8.use[2]!./node_modules/vue-loader/dist/index.js??ruleSet[0].use[0]!./resources/js/components/UnlayerEditor.vue?vue&type=style&index=0&id=657d8b0a&lang=css":
/*!********************************************************************************************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/css-loader/dist/cjs.js??clonedRuleSet-8.use[1]!./node_modules/vue-loader/dist/stylePostLoader.js!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-8.use[2]!./node_modules/vue-loader/dist/index.js??ruleSet[0].use[0]!./resources/js/components/UnlayerEditor.vue?vue&type=style&index=0&id=657d8b0a&lang=css ***!
  \********************************************************************************************************************************************************************************************************************************************************************************************************************************************/
/***/ ((module, __webpack_exports__, __webpack_require__) => {
...
/* harmony import */ var _node_modules_css_loader_dist_cjs_js_clonedRuleSet_8_use_1_node_modules_vue_loader_dist_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_clonedRuleSet_8_use_2_node_modules_vue_loader_dist_index_js_ruleSet_0_use_0_FormField_vue_vue_type_style_index_0_id_c023248a_scoped_true_lang_css__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! !!../../../node_modules/css-loader/dist/cjs.js??clonedRuleSet-8.use[1]!../../../node_modules/vue-loader/dist/stylePostLoader.js!../../../node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-8.use[2]!../../../node_modules/vue-loader/dist/index.js??ruleSet[0].use[0]!./FormField.vue?vue&type=style&index=0&id=c023248a&scoped=true&lang=css */ "./node_modules/css-loader/dist/cjs.js??clonedRuleSet-8.use[1]!./node_modules/vue-loader/dist/stylePostLoader.js!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-8.use[2]!./node_modules/vue-loader/dist/index.js??ruleSet[0].use[0]!./resources/js/components/FormField.vue?vue&type=style&index=0&id=c023248a&scoped=true&lang=css");
...
var update = _node_modules_style_loader_dist_runtime_injectStylesIntoStyleTag_js__WEBPACK_IMPORTED_MODULE_0___default()(_node_modules_css_loader_dist_cjs_js_clonedRuleSet_8_use_1_node_modules_vue_loader_dist_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_clonedRuleSet_8_use_2_node_modules_vue_loader_dist_index_js_ruleSet_0_use_0_FormField_vue_vue_type_style_index_0_id_c023248a_scoped_true_lang_css__WEBPACK_IMPORTED_MODULE_1__["default"], options);
...
/* harmony import */ var _node_modules_style_loader_dist_runtime_injectStylesIntoStyleTag_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! !../../../node_modules/style-loader/dist/runtime/injectStylesIntoStyleTag.js */ "./node_modules/style-loader/dist/runtime/injectStylesIntoStyleTag.js");
/* harmony import */ var _node_modules_style_loader_dist_runtime_injectStylesIntoStyleTag_js__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_node_modules_style_loader_dist_runtime_injectStylesIntoStyleTag_js__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _node_modules_css_loader_dist_cjs_js_clonedRuleSet_8_use_1_node_modules_vue_loader_dist_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_clonedRuleSet_8_use_2_node_modules_vue_loader_dist_index_js_ruleSet_0_use_0_UnlayerEditor_vue_vue_type_style_index_0_id_657d8b0a_lang_css__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! !!../../../node_modules/css-loader/dist/cjs.js??clonedRuleSet-8.use[1]!../../../node_modules/vue-loader/dist/stylePostLoader.js!../../../node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-8.use[2]!../../../node_modules/vue-loader/dist/index.js??ruleSet[0].use[0]!./UnlayerEditor.vue?vue&type=style&index=0&id=657d8b0a&lang=css */ "./node_modules/css-loader/dist/cjs.js??clonedRuleSet-8.use[1]!./node_modules/vue-loader/dist/stylePostLoader.js!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-8.use[2]!./node_modules/vue-loader/dist/index.js??ruleSet[0].use[0]!./resources/js/components/UnlayerEditor.vue?vue&type=style&index=0&id=657d8b0a&lang=css");
...
var update = _node_modules_style_loader_dist_runtime_injectStylesIntoStyleTag_js__WEBPACK_IMPORTED_MODULE_0___default()(_node_modules_css_loader_dist_cjs_js_clonedRuleSet_8_use_1_node_modules_vue_loader_dist_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_clonedRuleSet_8_use_2_node_modules_vue_loader_dist_index_js_ruleSet_0_use_0_UnlayerEditor_vue_vue_type_style_index_0_id_657d8b0a_lang_css__WEBPACK_IMPORTED_MODULE_1__["default"], options);
...
/* harmony import */ var _Users_louisbrown_PhpstormProjects_nova_unlayer_field_node_modules_vue_loader_dist_exportHelper_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./node_modules/vue-loader/dist/exportHelper.js */ "./node_modules/vue-loader/dist/exportHelper.js");




;
const __exports__ = /*#__PURE__*/(0,_Users_louisbrown_PhpstormProjects_nova_unlayer_field_node_modules_vue_loader_dist_exportHelper_js__WEBPACK_IMPORTED_MODULE_2__["default"])(_DetailField_vue_vue_type_script_lang_js__WEBPACK_IMPORTED_MODULE_1__["default"], [['render',_DetailField_vue_vue_type_template_id_0224618e__WEBPACK_IMPORTED_MODULE_0__.render],['__file',"resources/js/components/DetailField.vue"]])
/* hot reload */
if (false) {}
...
/* harmony import */ var _Users_louisbrown_PhpstormProjects_nova_unlayer_field_node_modules_vue_loader_dist_exportHelper_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./node_modules/vue-loader/dist/exportHelper.js */ "./node_modules/vue-loader/dist/exportHelper.js");
...
/***/ "./resources/js/components/UnlayerEditor.vue":
/*!***************************************************!*\
  !*** ./resources/js/components/UnlayerEditor.vue ***!
  \***************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _UnlayerEditor_vue_vue_type_template_id_657d8b0a__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./UnlayerEditor.vue?vue&type=template&id=657d8b0a */ "./resources/js/components/UnlayerEditor.vue?vue&type=template&id=657d8b0a");
/* harmony import */ var _UnlayerEditor_vue_vue_type_script_lang_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./UnlayerEditor.vue?vue&type=script&lang=js */ "./resources/js/components/UnlayerEditor.vue?vue&type=script&lang=js");
/* harmony import */ var _UnlayerEditor_vue_vue_type_style_index_0_id_657d8b0a_lang_css__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./UnlayerEditor.vue?vue&type=style&index=0&id=657d8b0a&lang=css */ "./resources/js/components/UnlayerEditor.vue?vue&type=style&index=0&id=657d8b0a&lang=css");
/* harmony import */ var _Users_louisbrown_PhpstormProjects_nova_unlayer_field_node_modules_vue_loader_dist_exportHelper_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./node_modules/vue-loader/dist/exportHelper.js */ "./node_modules/vue-loader/dist/exportHelper.js");
...
const __exports__ = /*#__PURE__*/(0,_Users_louisbrown_PhpstormProjects_nova_unlayer_field_node_modules_vue_loader_dist_exportHelper_js__WEBPACK_IMPORTED_MODULE_3__["default"])(_UnlayerEditor_vue_vue_type_script_lang_js__WEBPACK_IMPORTED_MODULE_1__["default"], [['render',_UnlayerEditor_vue_vue_type_template_id_657d8b0a__WEBPACK_IMPORTED_MODULE_0__.render],['__file',"resources/js/components/UnlayerEditor.vue"]])
/* hot reload */
if (false) {}
...
/***/ "./resources/js/components/UnlayerEditor.vue?vue&type=script&lang=js":
/*!***************************************************************************!*\
  !*** ./resources/js/components/UnlayerEditor.vue?vue&type=script&lang=js ***!
  \***************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "default": () => (/* reexport safe */ _node_modules_babel_loader_lib_index_js_clonedRuleSet_5_use_0_node_modules_vue_loader_dist_index_js_ruleSet_0_use_0_UnlayerEditor_vue_vue_type_script_lang_js__WEBPACK_IMPORTED_MODULE_0__["default"])
/* harmony export */ });
/* harmony import */ var _node_modules_babel_loader_lib_index_js_clonedRuleSet_5_use_0_node_modules_vue_loader_dist_index_js_ruleSet_0_use_0_UnlayerEditor_vue_vue_type_script_lang_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!../../../node_modules/vue-loader/dist/index.js??ruleSet[0].use[0]!./UnlayerEditor.vue?vue&type=script&lang=js */ "./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/dist/index.js??ruleSet[0].use[0]!./resources/js/components/UnlayerEditor.vue?vue&type=script&lang=js");
...
/***/ "./resources/js/components/UnlayerEditor.vue?vue&type=template&id=657d8b0a":
/*!*********************************************************************************!*\
  !*** ./resources/js/components/UnlayerEditor.vue?vue&type=template&id=657d8b0a ***!
  \*********************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "render": () => (/* reexport safe */ _node_modules_babel_loader_lib_index_js_clonedRuleSet_5_use_0_node_modules_vue_loader_dist_templateLoader_js_ruleSet_1_rules_2_node_modules_vue_loader_dist_index_js_ruleSet_0_use_0_UnlayerEditor_vue_vue_type_template_id_657d8b0a__WEBPACK_IMPORTED_MODULE_0__.render)
/* harmony export */ });
/* harmony import */ var _node_modules_babel_loader_lib_index_js_clonedRuleSet_5_use_0_node_modules_vue_loader_dist_templateLoader_js_ruleSet_1_rules_2_node_modules_vue_loader_dist_index_js_ruleSet_0_use_0_UnlayerEditor_vue_vue_type_template_id_657d8b0a__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!../../../node_modules/vue-loader/dist/templateLoader.js??ruleSet[1].rules[2]!../../../node_modules/vue-loader/dist/index.js??ruleSet[0].use[0]!./UnlayerEditor.vue?vue&type=template&id=657d8b0a */ "./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/dist/templateLoader.js??ruleSet[1].rules[2]!./node_modules/vue-loader/dist/index.js??ruleSet[0].use[0]!./resources/js/components/UnlayerEditor.vue?vue&type=template&id=657d8b0a");
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _node_modules_style_loader_dist_cjs_js_node_modules_css_loader_dist_cjs_js_clonedRuleSet_8_use_1_node_modules_vue_loader_dist_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_clonedRuleSet_8_use_2_node_modules_vue_loader_dist_index_js_ruleSet_0_use_0_FormField_vue_vue_type_style_index_0_id_c023248a_scoped_true_lang_css__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../node_modules/style-loader/dist/cjs.js!../../../node_modules/css-loader/dist/cjs.js??clonedRuleSet-8.use[1]!../../../node_modules/vue-loader/dist/stylePostLoader.js!../../../node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-8.use[2]!../../../node_modules/vue-loader/dist/index.js??ruleSet[0].use[0]!./FormField.vue?vue&type=style&index=0&id=c023248a&scoped=true&lang=css */ "./node_modules/style-loader/dist/cjs.js!./node_modules/css-loader/dist/cjs.js??clonedRuleSet-8.use[1]!./node_modules/vue-loader/dist/stylePostLoader.js!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-8.use[2]!./node_modules/vue-loader/dist/index.js??ruleSet[0].use[0]!./resources/js/components/FormField.vue?vue&type=style&index=0&id=c023248a&scoped=true&lang=css");


/***/ }),

/***/ "./resources/js/components/UnlayerEditor.vue?vue&type=style&index=0&id=657d8b0a&lang=css":
/*!***********************************************************************************************!*\
  !*** ./resources/js/components/UnlayerEditor.vue?vue&type=style&index=0&id=657d8b0a&lang=css ***!
  \***********************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _node_modules_style_loader_dist_cjs_js_node_modules_css_loader_dist_cjs_js_clonedRuleSet_8_use_1_node_modules_vue_loader_dist_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_clonedRuleSet_8_use_2_node_modules_vue_loader_dist_index_js_ruleSet_0_use_0_UnlayerEditor_vue_vue_type_style_index_0_id_657d8b0a_lang_css__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../node_modules/style-loader/dist/cjs.js!../../../node_modules/css-loader/dist/cjs.js??clonedRuleSet-8.use[1]!../../../node_modules/vue-loader/dist/stylePostLoader.js!../../../node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-8.use[2]!../../../node_modules/vue-loader/dist/index.js??ruleSet[0].use[0]!./UnlayerEditor.vue?vue&type=style&index=0&id=657d8b0a&lang=css */ "./node_modules/style-loader/dist/cjs.js!./node_modules/css-loader/dist/cjs.js??clonedRuleSet-8.use[1]!./node_modules/vue-loader/dist/stylePostLoader.js!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-8.use[2]!./node_modules/vue-loader/dist/index.js??ruleSet[0].use[0]!./resources/js/components/UnlayerEditor.vue?vue&type=style&index=0&id=657d8b0a&lang=css");
...
/*!*******************************!*\
  ...
  \*******************************/
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _components_UnlayerEditor_vue__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./components/UnlayerEditor.vue */ "./resources/js/components/UnlayerEditor.vue");
/* harmony import */ var _components_IndexField_vue__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./components/IndexField.vue */ "./resources/js/components/IndexField.vue");
/* harmony import */ var _components_DetailField_vue__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./components/DetailField.vue */ "./resources/js/components/DetailField.vue");
/* harmony import */ var _components_FormField_vue__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./components/FormField.vue */ "./resources/js/components/FormField.vue");
/* global Nova */
...
Nova.booting(function (app) {
  app.component('unlayer-editor', _components_UnlayerEditor_vue__WEBPACK_IMPORTED_MODULE_0__["default"]);
  app.component('index-nova-unlayer-field', _components_IndexField_vue__WEBPACK_IMPORTED_MODULE_1__["default"]);
  app.component('detail-nova-unlayer-field', _components_DetailField_vue__WEBPACK_IMPORTED_MODULE_2__["default"]);
  app.component('form-nova-unlayer-field', _components_FormField_vue__WEBPACK_IMPORTED_MODULE_3__["default"]);
});
})();
